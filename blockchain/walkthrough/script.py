...
class Blockchain:
    ...
    @staticmethod
    def hash(block):
        # receive one block. Turn it into a string, turn that into Unicode (for hashing). Hash
        # with SHA256 encryption, then translate the Unicode into a hexidecimal string.
